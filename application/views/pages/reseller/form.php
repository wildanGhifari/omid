            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <span>Reseller Product Form</span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_dropdown('id_reseller_category', getDropdownList('reseller_category', ['id', 'title']), $input->id_reseller_category, ['class' => 'form-control']) ?>
                            <?= form_error('id_reseller_category') ?>
                        </div>
                        <div class="form-group">
