        ...
        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="card-body">
                            Category : <strong><?= isset($category) ? $category : 'All Category' ?></strong>
                            <span class="float-right">
                                Sort Price By : <a href="<?= base_url("/shop/sortby/asc") ?>" class="badge badge-secondary">Lowest</a> | <a href="<?= base_url("/shop/sortby/desc") ?>" class="badge badge-secondary">Highest</a>
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?= base_url("/shop/category/$row->category_slug") ?>" class="badge badge-success"><i class="fas fa-tags"></i><?= $row->category_title; ?></a>
                            </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('shop/search') ?>" method="POST">
                                <div class="input-group">
                                    <input type="text" name="keyword" placeholder="Almond, Cranberry, etc. . ." value="<?= $this->session->userdata('keyword') ?>" class="form-control">
                                    <div class="input-group-append">
                ...
                <div class="col-md-12">
                    <div class="card mb-3">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><a href="<?= base_url('/') ?>">All Category</a></li>
