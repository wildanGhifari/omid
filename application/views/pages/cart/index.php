                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-6">
                                            <form action="<?= base_url("cart/delete/$row->id") ?>" method="POST">
                                                <input type="hidden" name="id" value="<?= $row->id ?>">
                                                <button style="width: 100%;" class="btn btn-outline-danger rounded-pill" type="submit" onclick="return confirm('Are you sure?')">Remove</i></button>
                                            </form>
                                        </div> -->
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h6 class="float-left font-weight-normal">Subtotal</h6>
                                        <h6 class="float-right font-weight-normal">Rp. <?= number_format(array_sum(array_column($content, 'subtotal')), 0, ',', '.') ?></h6>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <h6 class="float-left font-weight-normal">Shipping</h6>
                                        <h6 class="float-right font-weight-normal">Rp. 0</h6>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
        ...
        <div class="col-md-12">
            <div class="card mb-3">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('/checkout') ?>" class="btn btn-success float-right">Checkout Now <i class="fas fa-angle-right"></i></a>
                    <a href="<?= base_url('/') ?>" class="btn btn-warning text-white"><i class="fas fa-angle-left"></i> Keep
                        Shoping</a>
                </div>
            </div>
        </div>
