                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?= form_password('password', '', ['class' => 'form-control', 'placeholder' => 'Minimal 8 Character']) ?>
                            <?= form_error('password') ?>
                        </div>
                        <div class="form-group">
                        ...
                        <button style="width: 100%;" type="submit" class="btn btn-success rounded-0">Save</button>
                        <?= form_close() ?>
                    </div>
                </div>
            </div>
